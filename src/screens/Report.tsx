  ...
  return (
    <div style={{ fontFamily: C.fn, background: C.snow, minHeight: "100vh" }}>
      <div style={{ background: C.dark, color: C.white, padding: "44px 24px", textAlign: "center" }}>
        ...
        <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 16 }}>{T("congratulations").replace("{name}", s.name)}</h2>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16 }}>
          <div><div style={{ fontSize: 12, color: C.ash }}>{T("before")}</div><div style={{ fontSize: 28, fontWeight: 800, color: C.ash }}>{start}%</div></div>
          <div style={{ fontSize: 22, color: C.teal }}>→</div>
          <div><div style={{ fontSize: 12, color: C.teal }}>{T("after")}</div><div style={{ fontSize: 28, fontWeight: 800, color: C.teal }}>{final}%</div></div>
        </div>
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: 24 }}>
        <div style={{ background: C.white, border: `1.5px solid ${C.border}`, padding: "28px 24px", marginBottom: 20 }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 16 }}>
            <div>
              <div style={{ fontSize: 16, fontWeight: 800, color: C.charcoal }}>{T("onboarding_report")}</div>
        ...
        {s.signed && (
          <div style={{ background: C.white, border: `3px solid ${C.gold}`, padding: "36px 28px", textAlign: "center", marginBottom: 20, position: "relative" }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 300, color: C.charcoal, fontStyle: "italic" }}>{T("certificate_completion")}</div>
