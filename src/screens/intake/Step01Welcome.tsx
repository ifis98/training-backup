    ...
    <div style={{ fontFamily: C.fn, background: C.dark, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: isMobile ? '0 16px 80px' : '0 24px' }}>
        <div style={{ maxWidth: 520, width: '100%' }}>
          ...
          <h1 style={{ fontSize: isMobile ? 26 : 32, fontWeight: 800, color: C.white, lineHeight: 1.25, marginBottom: 16 }}>
            Get Your Practice Ready for ByteSense
          </h1>
          <p style={{ fontSize: 15, color: C.ash, lineHeight: 1.75, marginBottom: 32 }}>
            This takes about <strong style={{ color: C.white }}>2–3 minutes</strong>. No prep needed — just answer based on your current setup.
            <br /><br />
          ...
          <div style={{ background: C.dark2, border: `1px solid ${C.borderD}`, padding: isMobile ? '16px' : '20px', marginBottom: 32, borderLeft: `3px solid ${C.teal}` }}>
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 13, color: C.white, lineHeight: 1.5 }}>{item}</span>
              </div>
            ))}
          </div>
